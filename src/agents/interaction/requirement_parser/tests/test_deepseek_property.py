...
from src.agents.interaction.requirement_parser.models import DeepSeekResponse
from src.agents.interaction.requirement_parser.exceptions import (
    DeepSeekAPIError,
    APITimeoutError,
    APIRateLimitError,
    NetworkError
...
class TestAPIRetryLogicProperty:
    ...
    async def test_max_retries_respected(self, max_retries):
        ...
        # Act & Assert
        from src.agents.interaction.requirement_parser.exceptions import MaxRetriesExceededError
